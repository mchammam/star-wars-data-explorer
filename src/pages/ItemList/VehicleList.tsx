import { useFetchVehicleList } from '../../hooks/api/useFetchVehicleList';
...
import VehicleListItem from '../../components/ListItems/VehicleListItem';
...
function VehicleList() {
  ...
  const {
    ...
    totalItems,
    currentPageNumber,
  } = useFetchVehicleList({ searchQuery: debouncedSearchQuery });
  ...
  return (
    ...
    >
      <>
        {items?.map((vehicle) => (
          <VehicleListItem key={vehicle.url} vehicle={vehicle} />
        ))}
