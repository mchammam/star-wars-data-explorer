import { useFetchSpecieList } from '../../hooks/api/useFetchSpecieList';
...
import SpecieListItem from '../../components/ListItems/SpecieListItem';
...
function SpecieList() {
  ...
  const {
    ...
    totalItems,
    currentPageNumber,
  } = useFetchSpecieList({ searchQuery: debouncedSearchQuery });
  ...
  return (
    ...
    >
      <>
        {items?.map((specie) => (
          <SpecieListItem key={specie.url} specie={specie} />
        ))}
